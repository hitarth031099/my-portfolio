            ...
            <nav aria-label="main mailbox folders">
              <List>
                <ListItem disablePadding  className="contact-list-item">
                  <ListItemButton  href="https://www.linkedin.com/in/-hitarthpatel/" target="_blank">
                    <ListItemIcon>
                ...
                <ListItem disablePadding className="contact-list-item">
                  <ListItemButton href="https://github.com/hitarth031099" target="_blank">
                    <ListItemIcon>
                ...
                <ListItem disablePadding className="contact-list-item">
                  <ListItemButton
                    onClick={() =>
                      (window.location = "mailto: hitarthpatelcs@gmail.com")
                    }
                  >
                    <ListItemIcon>
                    ...
                    <ListItemText
                      primary="Mail (hitarthpatelcs@gmail.com)"
