...
const resumeURL = "https://drive.google.com/file/d/1tPkwCBYlDA0lWUVk62bP3McfumkxI_06/view?usp=sharing";
    ...
    <div className="homeBottom" >
      ...
      <div className="introduction">
        <div className="intro-text">
          <p>
            I am Hitarth Patel, currently a graduate student at{" "}
            <span style={{ color: "#32CD30" }}>Stevens Institute of Technology</span>
                 </p>
          <br />
          <p>
            I love working as a <span style={{ color: "#32CD30" }}>Full Stack Developer</span> and My tech stack includes
            NodeJs, Angular, React, TypeScript. I am also familar with AWS and
            Docker.
          </p>
          <br />
          <p>
